...
void Crypto__signature(void)
{
    if((((((((((((((((Crypto__Signature_Algorithm == Crypto__RSA) ||
                ...
                (Crypto__Data_Status == Crypto__Encrypted_Written_Sourcecode)) &&
            (Crypto__Data_Status == Crypto__Signed_Written_Sourcecode)) &&
...
void Crypto__send_message(void)
{
    if(((((((((((((((Crypto__Subject == Crypto__Development_Server) ||
        ...
        (Crypto__Send_Encrypt_Message == Crypto__Encrypted_Written_Sourcecode)) &&
    (Crypto__Send_Sign_Message == Crypto__Signed_Written_Sourcecode))
    {
        Crypto__Send_Target = Crypto__Diagnostic_Server;
    }
    else
    {
        Crypto__Send_Target = Crypto__Empty_Agent;
