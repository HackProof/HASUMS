...
THEORY ListSubstitutionX IS
  ...
  List_Substitution(Implementation(Automotive_Login_i),access_grant)==(IF Input_ID = Update_Server_ID & Input_Agent = Update_Server & Login_Try<=5 THEN Agent:=Access_Success;Permission:=Download;Login_Try:=0;printf("Login Success!\n");printf("Login Entity: Update_Server\n");printf("============================\n") ELSE Agent:=Access_Fail;Permission:=None;Login_Try:=Login_Try+1;printf("Login Fail!\n");printf("============================\n") END);
