...
THEORY ListVisibleVariablesX IS
  Inherited_List_VisibleVariables(Implementation(Automotive_Login_i))==(Agent,Permission,Login_Try,Input_Agent,Input_Password,Input_ID);
  Abstract_List_VisibleVariables(Implementation(Automotive_Login_i))==(Agent,Permission,Login_Try,Input_Agent,Input_Password,Input_ID);
...
THEORY ListInvariantX IS
  ...
  Abstract_List_Invariant(Implementation(Automotive_Login_i))==(Input_ID: Access_ID & Input_Password: Access_Password & Input_Agent: Access_Agent & Login_Try: INT & Permission: Operation & Agent: Access_grant);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(Automotive_Login_i))==(Input_ID:=Empty_ID;Input_Password:=Empty_Password;Input_Agent:=Empty_Agent;(0: INT | Login_Try:=0);Permission:=None;Agent:=Access_Fail);
  Context_List_Initialisation(Implementation(Automotive_Login_i))==(skip);
  List_Initialisation(Implementation(Automotive_Login_i))==(Input_ID:=Empty_ID;Input_Password:=Empty_Password;Input_Agent:=Empty_Agent;Login_Try:=0;Permission:=None;Agent:=Access_Fail)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(Automotive_Login_i))==(access_grant);
  List_Operations(Implementation(Automotive_Login_i))==(access_grant)
END
&
THEORY ListInputX IS
  List_Input(Implementation(Automotive_Login_i),access_grant)==(?)
END
&
...
THEORY ListHeaderX IS
  List_Header(Implementation(Automotive_Login_i),access_grant)==(access_grant)
END
&
THEORY ListPreconditionX IS
  Own_Precondition(Implementation(Automotive_Login_i),access_grant)==(btrue);
  List_Precondition(Implementation(Automotive_Login_i),access_grant)==(btrue)
END
&
...
THEORY ListSetsX IS
  ...
  List_Own_Enumerated(Implementation(Automotive_Login_i))==(Access_ID,Access_Password,Access_Agent,Operation,Access_grant);
  List_Valuable_Sets(Implementation(Automotive_Login_i))==(?);
  Inherited_List_Enumerated(Implementation(Automotive_Login_i))==(Access_ID,Access_Password,Access_Agent,Operation,Access_grant);
  Inherited_List_Defered(Implementation(Automotive_Login_i))==(?);
  Inherited_List_Sets(Implementation(Automotive_Login_i))==(Access_ID,Access_Password,Access_Agent,Operation,Access_grant);
...
THEORY ListPropertiesX IS
  Abstract_List_Properties(Implementation(Automotive_Login_i))==(Access_ID: FIN(INTEGER) & not(Access_ID = {}) & Access_Password: FIN(INTEGER) & not(Access_Password = {}) & Access_Agent: FIN(INTEGER) & not(Access_Agent = {}) & Operation: FIN(INTEGER) & not(Operation = {}) & Access_grant: FIN(INTEGER) & not(Access_grant = {}));
...
THEORY InheritedEnvX IS
  ...
  VisibleVariables(Implementation(Automotive_Login_i))==(Type(Agent) == Mvv(etype(Access_grant,?,?));Type(Permission) == Mvv(etype(Operation,?,?));Type(Login_Try) == Mvv(btype(INTEGER,?,?));Type(Input_Agent) == Mvv(etype(Access_Agent,?,?));Type(Input_Password) == Mvv(etype(Access_Password,?,?));Type(Input_ID) == Mvv(etype(Access_ID,?,?)));
...
&
THEORY SetsEnvX IS
  Sets(Implementation(Automotive_Login_i)) == (Type(Access_grant) == Cst(SetOf(etype(Access_grant,0,1)));Type(Operation) == Cst(SetOf(etype(Operation,0,8)));Type(Access_Agent) == Cst(SetOf(etype(Access_Agent,0,10)));Type(Access_Password) == Cst(SetOf(etype(Access_Password,0,3)));Type(Access_ID) == Cst(SetOf(etype(Access_ID,0,5))))
END
&
THEORY ConstantsEnvX IS
  Constants(Implementation(Automotive_Login_i)) == (Type(Access_Fail) == Cst(etype(Access_grant,0,1));Type(Access_Success) == Cst(etype(Access_grant,0,1));Type(Upload_Fix_Transfer_Download_Approve) == Cst(etype(Operation,0,8));Type(Upload_Fix_Transfer) == Cst(etype(Operation,0,8));Type(Approve) == Cst(etype(Operation,0,8));Type(Download) == Cst(etype(Operation,0,8));Type(Transfer) == Cst(etype(Operation,0,8));Type(Fix) == Cst(etype(Operation,0,8));Type(Upload) == Cst(etype(Operation,0,8));Type(All) == Cst(etype(Operation,0,8));Type(None) == Cst(etype(Operation,0,8));Type(Engineer_PC) == Cst(etype(Access_Agent,0,10));Type(DiagnosticTester_PC) == Cst(etype(Access_Agent,0,10));Type(Developer_PC) == Cst(etype(Access_Agent,0,10));Type(CRM_Server) == Cst(etype(Access_Agent,0,10));Type(Update_Server) == Cst(etype(Access_Agent,0,10));Type(Diagnostic_Server) == Cst(etype(Access_Agent,0,10));Type(Development_Server) == Cst(etype(Access_Agent,0,10));Type(Vehicle) == Cst(etype(Access_Agent,0,10));Type(Auto_Repair_Shop) == Cst(etype(Access_Agent,0,10));Type(Secondary_ECU) == Cst(etype(Access_Agent,0,10));Type(Empty_Agent) == Cst(etype(Access_Agent,0,10));Type(OEM_TeamMember_Password) == Cst(etype(Access_Password,0,3));Type(OEM_TeamLeader_Password) == Cst(etype(Access_Password,0,3));Type(Engineer_Password) == Cst(etype(Access_Password,0,3));Type(Empty_Password) == Cst(etype(Access_Password,0,3));Type(Engineer_ID) == Cst(etype(Access_ID,0,5));Type(Update_Server_ID) == Cst(etype(Access_ID,0,5));Type(Vehicle_ID) == Cst(etype(Access_ID,0,5));Type(OEM_TeamMember_ID) == Cst(etype(Access_ID,0,5));Type(OEM_TeamLeader_ID) == Cst(etype(Access_ID,0,5));Type(Empty_ID) == Cst(etype(Access_ID,0,5)))
END
&
THEORY VisibleVariablesEnvX IS
  VisibleVariables(Implementation(Automotive_Login_i)) == (Type(Input_ID) == Mvv(etype(Access_ID,?,?));Type(Input_Password) == Mvv(etype(Access_Password,?,?));Type(Input_Agent) == Mvv(etype(Access_Agent,?,?));Type(Login_Try) == Mvv(btype(INTEGER,?,?));Type(Permission) == Mvv(etype(Operation,?,?));Type(Agent) == Mvv(etype(Access_grant,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(Automotive_Login_i))==(Agent: Access_grant & Permission: Operation & Login_Try: INTEGER & Input_Agent: Access_Agent & Input_Password: Access_Password & Input_ID: Access_ID)
END
&
