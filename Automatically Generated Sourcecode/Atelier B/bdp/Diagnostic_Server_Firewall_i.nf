...
THEORY ListVisibleVariablesX IS
  Inherited_List_VisibleVariables(Implementation(Diagnostic_Server_Firewall_i))==(Communication_Timeout,Agent,Input_Port,Available_Port,Input_IP_List,Input_IP,Input_Agent);
  Abstract_List_VisibleVariables(Implementation(Diagnostic_Server_Firewall_i))==(Communication_Timeout,Agent,Input_Port,Available_Port,Input_IP_List,Input_IP,Input_Agent);
...
THEORY ListInvariantX IS
  ...
  Abstract_List_Invariant(Implementation(Diagnostic_Server_Firewall_i))==(Input_Agent: Access_Agent & Input_IP: Access_IP & Input_IP_List: Access_IP_List & Input_Port: INT & Available_Port: INT & Agent: Access_grant & Communication_Timeout: INT);
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(Diagnostic_Server_Firewall_i))==(Input_Agent:=Empty_Agent;Input_IP:=Empty_IP;Input_IP_List:=IP_Unknown;(443: INT | Available_Port:=443);(0: INT | Input_Port:=0);Agent:=Access_Fail;(600: INT | Communication_Timeout:=600));
  Context_List_Initialisation(Implementation(Diagnostic_Server_Firewall_i))==(skip);
  List_Initialisation(Implementation(Diagnostic_Server_Firewall_i))==(Input_Agent:=Empty_Agent;Input_IP:=Empty_IP;Input_IP_List:=IP_Unknown;Available_Port:=443;Input_Port:=0;Agent:=Access_Fail;Communication_Timeout:=600)
END
&
...
THEORY InheritedEnvX IS
  ...
  VisibleVariables(Implementation(Diagnostic_Server_Firewall_i))==(Type(Communication_Timeout) == Mvv(btype(INTEGER,?,?));Type(Agent) == Mvv(etype(Access_grant,?,?));Type(Input_Port) == Mvv(btype(INTEGER,?,?));Type(Available_Port) == Mvv(btype(INTEGER,?,?));Type(Input_IP_List) == Mvv(etype(Access_IP_List,?,?));Type(Input_IP) == Mvv(etype(Access_IP,?,?));Type(Input_Agent) == Mvv(etype(Access_Agent,?,?)));
...
THEORY TypingPredicateX IS
  TypingPredicate(Implementation(Diagnostic_Server_Firewall_i))==(Communication_Timeout: INTEGER & Agent: Access_grant & Input_Port: INTEGER & Available_Port: INTEGER & Input_IP_List: Access_IP_List & Input_IP: Access_IP & Input_Agent: Access_Agent)
END
&
