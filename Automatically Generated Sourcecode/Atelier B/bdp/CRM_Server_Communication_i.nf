...
&
THEORY ListSetsX IS
  Set_Definition(Implementation(CRM_Server_Communication_i),Data_Processing)==({All,Pseudonymization,Masking});
  ...
  List_Own_Enumerated(Implementation(CRM_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status,Data_Processing);
  List_Valuable_Sets(Implementation(CRM_Server_Communication_i))==(?);
  Inherited_List_Enumerated(Implementation(CRM_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status,Data_Processing);
  Inherited_List_Defered(Implementation(CRM_Server_Communication_i))==(?);
  Inherited_List_Sets(Implementation(CRM_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status,Data_Processing);
