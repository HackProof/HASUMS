...
THEORY ListSubstitutionX IS
  ...
  List_Substitution(Implementation(Development_Server_Login_i),access_grant)==(IF Input_ID = OEM_TeamLeader_ID & Input_Password = OEM_TeamLeader_Password & Input_Agent = Developer_PC & Login_Try<=5 & Input_String_Length<Buffer_Length THEN Agent:=Access_Success;Permission:=Upload_Fix_Transfer_Download_Approve;Login_Try:=0;STRING_WRITE("Login Success!\n");STRING_WRITE("Login Entity: OEM_TeamLeader\n");STRING_WRITE("============================\n") ELSE IF Input_ID = OEM_TeamMember_ID & Input_Password = OEM_TeamMember_Password & Input_Agent = Developer_PC & Login_Try<=5 & Input_String_Length<Buffer_Length THEN Agent:=Access_Success;Permission:=Upload_Fix_Transfer;Login_Try:=0;STRING_WRITE("Login Success!\n");STRING_WRITE("Login Entity: OEM_TeamMember\n");STRING_WRITE("============================\n") ELSE Agent:=Access_Fail;Permission:=None;Login_Try:=Login_Try+1;STRING_WRITE("Login Fail!\n");STRING_WRITE("============================\n") END END);
