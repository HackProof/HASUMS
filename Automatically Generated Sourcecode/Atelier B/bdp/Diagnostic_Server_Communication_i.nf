...
THEORY ListVisibleVariablesX IS
  Inherited_List_VisibleVariables(Implementation(Diagnostic_Server_Communication_i))==(Data_Status,Send_Target,Test_Result,Hash_Key_length,Signature_Key_length,Encryption_Key_length,Permission,Send_Sign_Message,Send_Encrypt_Message,Receive_Sign_Message,Receive_Encrypt_Message,Hash_Algorithm,Signature_Algorithm,Encryption_Mode,Encryption_Algorithm,Subject);
  Abstract_List_VisibleVariables(Implementation(Diagnostic_Server_Communication_i))==(Data_Status,Send_Target,Test_Result,Hash_Key_length,Signature_Key_length,Encryption_Key_length,Permission,Send_Sign_Message,Send_Encrypt_Message,Receive_Sign_Message,Receive_Encrypt_Message,Hash_Algorithm,Signature_Algorithm,Encryption_Mode,Encryption_Algorithm,Subject);
...
THEORY ListSetsX IS
  ...
  List_Own_Enumerated(Implementation(Diagnostic_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status);
  List_Valuable_Sets(Implementation(Diagnostic_Server_Communication_i))==(?);
  Inherited_List_Enumerated(Implementation(Diagnostic_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status);
  Inherited_List_Defered(Implementation(Diagnostic_Server_Communication_i))==(?);
  Inherited_List_Sets(Implementation(Diagnostic_Server_Communication_i))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status);
