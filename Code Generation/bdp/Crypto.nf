...
THEORY ListVisibleVariablesX IS
  ...
  List_VisibleVariables(Machine(Crypto))==(Data_Status,Send_Target,Test_Result,Hash_Key_length,Signature_Key_length,Encryption_Key_length,Permission,Send_Sign_Message,Send_Encrypt_Message,Receive_Sign_Message,Receive_Encrypt_Message,Hash_Algorithm,Signature_Algorithm,Encryption_Mode,Encryption_Algorithm,Subject);
  Internal_List_VisibleVariables(Machine(Crypto))==(Data_Status,Send_Target,Test_Result,Hash_Key_length,Signature_Key_length,Encryption_Key_length,Permission,Send_Sign_Message,Send_Encrypt_Message,Receive_Sign_Message,Receive_Encrypt_Message,Hash_Algorithm,Signature_Algorithm,Encryption_Mode,Encryption_Algorithm,Subject)
END
&
...
THEORY ListSetsX IS
  ...
  List_Enumerated(Machine(Crypto))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status);
  List_Defered(Machine(Crypto))==(?);
  List_Sets(Machine(Crypto))==(Subject_Agent,Encrypt_Method,Encrypt_Mode,Crypto_Test_Result,Sign_Method,Hash_Method,Operation,Message_Status);
