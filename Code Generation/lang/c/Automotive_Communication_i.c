...
void Crypto__receive_message(void)
{
    if((((((((((((((((Crypto__Subject == Crypto__Update_Server) ||
                                                            (Crypto__Subject == Crypto__Auto_Repair_Shop)) ||
...
{
    if((Crypto__Data_Status == Crypto__Encrypted_Binary) &&
    (Crypto__Permission == Crypto__Decrypt))
    {
        Crypto__Data_Status = Crypto__Decrypted_Binary;
    }
}
...
void Crypto__signature(void)
{
    if((((((((((((((((Crypto__Signature_Algorithm == Crypto__RSA) ||
                        ...
                        (Crypto__Hash_Key_length == 384)) ||
                    (Crypto__Hash_Key_length == 512)) &&
                (Crypto__Data_Status == Crypto__Encrypted_Vehicle_Data)) &&
            (Crypto__Data_Status == Crypto__Signed_Vehicle_Data)) &&
        (Crypto__Subject == Crypto__Vehicle)) &&
...
void Crypto__send_message(void)
{
    if(((((((((((((((Crypto__Subject == Crypto__Vehicle) ||
                ...
                (Crypto__Encryption_Mode == Crypto__GCM)) ||
            (Crypto__Encryption_Mode == Crypto__CCM)) &&
        (Crypto__Send_Encrypt_Message == Crypto__Encrypted_Vehicle_Data)) &&
    (Crypto__Send_Sign_Message == Crypto__Signed_Vehicle_Data))
    {
        Crypto__Send_Target = Crypto__CRM_Server;
    }
    else
    {
        Crypto__Send_Target = Crypto__Empty_Agent;
