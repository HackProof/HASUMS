...
{
    if((((((Network__Input_Agent == Network__Development_Server) ||
                    (Network__Input_Agent == Network__DiagnosticTester_PC)) &&
                (Network__Input_IP == Network__Development_Server_IP)) ||
            (Network__Input_IP == Network__DiagnosticTester_PC_IP)) &&
