...
{
    if(((((((((((((((Crypto__Subject == Crypto__Development_Server) ||
                                                        (Crypto__Subject == Crypto__Diagnostic_Server)) &&
        ...
        (Crypto__Receive_Encrypt_Message == Crypto__Encrypted_Written_Sourcecode)) &&
    (Crypto__Receive_Sign_Message == Crypto__Signed_Written_Sourcecode))
    {
        Crypto__Subject = Crypto__Diagnostic_Server;
...
void Crypto__signature_verify(int32_t Timestamp, int32_t Current_Timestamp, int32_t Timestamp_Subtraction)
{
    if(((((((((((((((((Crypto__Signature_Algorithm == Crypto__RSA) ||
                    ...
                    (Crypto__Data_Status == Crypto__Decrypted_Sourcecode)) &&
                (Crypto__Data_Status == Crypto__Decrypted_Signed_Sourcecode)) &&
            (Crypto__Decrypted_Sourcecode == Crypto__Decrypted_Signed_Sourcecode)) &&
...
void Crypto__signature(void)
{
    if((((((((((((((((Crypto__Signature_Algorithm == Crypto__RSA) ||
        ...
        (Crypto__Subject == Crypto__OEM_TeamLeader)) &&
...
{
    if(((((((((((((((Crypto__Subject == Crypto__Diagnostic_Server) ||
                                                        (Crypto__Subject == Crypto__Development_Server)) &&
                                                    (Crypto__Encryption_Algorithm == Crypto__AES)) &&
                                                (Crypto__Encryption_Key_length == 512)) ||
                                            (Crypto__Encryption_Key_length == 1024)) ||
                                        (Crypto__Encryption_Key_length == 2048)) &&
                ...
                (Crypto__Encryption_Mode == Crypto__GCM)) ||
            (Crypto__Encryption_Mode == Crypto__CCM)) &&
        (Crypto__Send_Encrypt_Message == Crypto__Encrypted_Sourcecode)) &&
    (Crypto__Send_Sign_Message == Crypto__Signed_Sourcecode))
    {
        Crypto__Send_Target = Crypto__Developer_PC;
    }
    else
    {
        if(((((((((((((((Crypto__Subject == Crypto__Diagnostic_Server) ||
                                                            (Crypto__Subject == Crypto__Update_Server)) &&
                                                        (Crypto__Encryption_Algorithm == Crypto__AES)) &&
                                                    (Crypto__Encryption_Key_length == 512)) ||
                                                (Crypto__Encryption_Key_length == 1024)) ||
                                            (Crypto__Encryption_Key_length == 2048)) &&
        ...
        {
            Crypto__Send_Target = Crypto__Update_Server;
        }
        else
        {
            Crypto__Send_Target = Crypto__Empty_Agent;
